...
export const metadata = {
  title: "Contacto | Reservá tu estadía en ALMAMARKA",
  description:
    "Contactanos para consultas, reservas o más información. Estamos para ayudarte a planificar tu experiencia en nuestro refugio natural.",
  icons: {
    icon: "/favicon.ico",
